  ...
  <div id="balanceReport" class="public-container2">
    <el-row class="Rtitle">
      <el-col :span="12">
        ...
        <el-select placeholder="" size="small" v-model="fzType" style="width: 110px">
    ...
    <div class="resizeBox">
      <table id="resizeTable">
        ...
        <tr>
          ...
          <th class="icon-r" colspan="1" rowspan="2">编码</th>
        ...
        <tr v-for="(item,index) in tableData5" :key="index" v-show="item.expand" @mouseenter="mouseEnter(index)" @click="rowClick(index)">
          ...
          <td class="icon-r align_left" :class="{pl15:item.parent, 'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.code}}</td>
          <td :class="{pl15:item.parent, 'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}" class="align_left">{{item.name}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.jf_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.df_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.cm_jf_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.cm_df_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.cym_jf_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.cym_df_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.fcm_jf_money}}</td>
          <td class="align_right" :class="{'hover-bg': index == currentHoverRow, 'click-bg': index == currentClickRow}">{{item.fcm_df_money}}</td>
        </tr>
        </tbody>
      </table>
    </div>
    ...
    data(){
      return{
        ...
        tableData5: [{
          ...
          jf_money: '33,897.00',
          df_money: '',
          cm_jf_money: '33,897.00',
          cm_df_money: '',
          cym_jf_money: '33,897.00',
          cym_df_money: '',
          fcm_jf_money: '33,897.00',
          fcm_df_money: '',
          expand:true,
          node:'one',
          clicked:false,
